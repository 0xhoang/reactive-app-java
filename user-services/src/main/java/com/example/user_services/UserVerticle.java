package com.example.user_services;
...
public class UserVerticle extends AbstractVerticle {
  ...
  public static void main(String[] args) {
    ...
    // Configure the file store options for config.json
    ConfigStoreOptions fileStore = new ConfigStoreOptions()
      .setType("file")
      .setFormat("json")
      .setConfig(new JsonObject().put("path", "/Users/lap01894/MyJob/vertx-app/user-services/src/main/resources/config.json"));
    ...
    retriever.rxGetConfig()
      .subscribe(config -> {
        ...
        Vertx newVertx = io.vertx.reactivex.core.Vertx.vertx(options);
        newVertx.rxDeployVerticle(new UserVerticle(), new DeploymentOptions().setConfig(config))
          .subscribe(
